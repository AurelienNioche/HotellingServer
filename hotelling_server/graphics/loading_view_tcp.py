...
class LoadGameNewGameFrameTCP(QWidget, Logger):

    name = "LoadGameNewGameTCP"
    ...
    def prepare_network(self):
        ...
        self.widgets["ip_address"].setEnabled(not self.param["network"]["local"])

        self.widgets["localhost"].setChecked(self.param["network"]["local"])
    ...
    def click_new_game(self):
        ...
        self.parent().show_frame_assignment_tcp()
    ...
    def save_network_parameters(self):
        ...
        self.param["network"]["ip_address"] = self.widgets["ip_address"].text()
        self.param["network"]["local"] = self.widgets["localhost"].isChecked()
